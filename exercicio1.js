...
if ((idade > 21 && idade < 56) && (salario >= 1000) && (emprestimo <= limiteEmprestimo) && (parcela >=3 && parcela <=20)) {
    ...
    switch (resposta){
        ...
        alert(`O total do empréstimo com JUROS de 8% ao mês é: \nR$${jurosComposto.toFixed(2)} \n\nVocê pagará em ${parcela} vezes de R$${totalParcela.toFixed(2)}`);
        alert("Muito obrigado!");
